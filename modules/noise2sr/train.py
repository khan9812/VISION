import torch
from modules.noise2sr import netarch
import tifffile as tiffile
import json
import argparse
import numpy as np
from modules.noise2sr import dataset
from tqdm import tqdm
import os

# Import local utils explicitly to avoid conflicts
...
def train(config, noisy_data):
    ...
    Subsampler = noise2sr_utils.PD_sampler(s, DEVICE)
